...
public class MicrophoneModel extends Model {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 16).addBox(-1.0F, 1.0F, -4.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
